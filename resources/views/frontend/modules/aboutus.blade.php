...
@section('Content')
<div class="breadcrumb-area pt-255 pb-170" style="background-image: url({{URL::to('')}}/public/assets/frontend/img/banner/banner-4.jpg)">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-12">
                            <div class="overview-img">
                                <img class="tilter" src="{{URL::to('')}}/public/assets/frontend/img/banner/banner-1.png" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6">
                            <div class="single-services orange mb-30 text-center">
                                <div class="services-icon">
                                    ...
                                    <img alt="" src="{{URL::to('')}}/public/assets/frontend/img/icon-img/3.png">
                                    }
                                </div>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="single-services yellow mb-30 text-center">
                                <div class="services-icon">
                                    <img alt="" src="{{URL::to('')}}/public/assets/frontend/img/icon-img/4.png">
                                </div>
                                <div class="services-text">
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="single-services purple mb-30 text-center">
                                <div class="services-icon">
                                    <img alt="" src="{{URL::to('')}}/public/assets/frontend/img/icon-img/5.png">
                                </div>
                                <div class="services-text">
                                    <h5>MONEY RETURN</h5>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="single-services sky mb-30 text-center">
                                <div class="services-icon">
                                    <img alt="" src="{{URL::to('')}}/public/assets/frontend/img/icon-img/6.png">
                                </div>
                                <div class="services-text">
                            ...
                            <div class="row">
                                <div class="col-lg-5">
                                    <div class="testimonial-img pl-75">
                                        <img alt="image" src="{{URL::to('')}}/public/assets/frontend/img/team/testimonial-1.jpg">
                                    </div>
                                </div>
                                <div class="col-lg-7">
                        ...
                        <div class="single-testimonial">
                            <div class="row">
                                <div class="col-lg-5 col-md-12 col-12">
                                    <div class="testimonial-img pl-75">
                                        <img alt="image" src="{{URL::to('')}}/public/assets/frontend/img/team/testimonial-2.png">
                                    </div>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6 col-12">
                            <div class="team-wrapper mb-30">
                                <div class="team-img">
                                    <img src="{{URL::to('')}}/public/assets/frontend/img/team/1.jpg" alt="">
                                </div>
                        ...
                        <div class="col-lg-3 col-md-6 col-12">
                            <div class="team-wrapper mb-30">
                                <div class="team-img">
                                    <img src="{{URL::to('')}}/public/assets/frontend/img/team/2.jpg" alt="">
                                </div>
                                <div class="team-content">
                                    <h4>Sienna Nguyen</h4>
                                    <span>Manager </span>
                        ...
                        <div class="col-lg-3 col-md-6 col-12">
                            <div class="team-wrapper mb-30">
                                <div class="team-img">
                                    <img src="{{URL::to('')}}/public/assets/frontend/img/team/3.jpg" alt="">
                                </div>
                                <div class="team-content">
                                    <h4>Liam Ryan</h4>
                                    <span>Director </span>
                        ...
                        <div class="col-lg-3 col-md-6 col-12">
                            <div class="team-wrapper mb-30">
                                <div class="team-img">
                                    <img src="{{URL::to('')}}/public/assets/frontend/img/team/4.jpg" alt="">
                                </div>
                                <div class="team-content">
                    ...
                    <div class="newsletter-wrapper-all theme-bg-2">
                        <div class="row">
                            <div class="col-lg-5 col-12 col-md-12">
                                <div class="newsletter-img bg-img" style="background-image: url({{URL::to('')}}/public/assets/frontend/img/banner/newsletter-bg.png)">
                                    <img alt="image" src="{{URL::to('')}}/public/assets/frontend/img/team/newsletter-img.png">
                                </div>
                            </div>
